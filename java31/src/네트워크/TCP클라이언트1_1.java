...
public class TCP클라이언트1_1 {

	public static void main(String[] args) throws Exception {		
	
		for (int i = 0; i < 500; i++) {	        
			Socket socket = new Socket("localhost", 9000);//생성자에는 연결 요청해주는 기능, 객체생성
...
//			BufferedReader buffer = new BufferedReader(reader);//2바이트 단위로 처리, BuffredReader클래스는 문자들을 줄 단위로 가지고 와서 처리할 수 있는 클래스, 문자로 변환시키는 클래스
